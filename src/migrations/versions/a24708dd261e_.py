...
Revision ID: a24708dd261e
Revises: 3f9d182020a3
Create Date: 2025-04-27 12:48:44.632014
...
revision = 'a24708dd261e'
down_revision = '3f9d182020a3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('category_embeddings', schema=None) as batch_op:
        batch_op.alter_column('avg_embedding',
               existing_type=sa.ARRAY(sa.FLOAT),  # Sử dụng đúng kiểu dữ liệu cũ nếu có
               type_=Vector(384),  # Sử dụng pgvector để định nghĩa kiểu VECTOR với chiều 384
               nullable=False)
